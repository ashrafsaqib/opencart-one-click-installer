...
CREATE TABLE `oc_affiliate_login` (
  `affiliate_login_id` int NOT NULL AUTO_INCREMENT,
  `email` varchar(96) NOT NULL,
  `ip` varchar(40) NOT NULL,
  `total` int NOT NULL,
  `date_added` datetime NOT NULL,
...
(1,	'Default',	'',	1,	'2025-12-18 16:52:24',	'2025-12-18 16:52:24');
...
CREATE TABLE `oc_order_custom_field` (
  `order_custom_field_id` int NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL,
  `custom_field_id` int NOT NULL,
  `custom_field_value_id` int NOT NULL,
  `name` varchar(255) NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=177 DEFAULT CHARSET=utf8mb3;
...
(174,	0,	'config',	'config_email',	'admin@gmail.com',	0),
...
(175,	0,	'config',	'config_encryption',	'',	0),
...
(1,	1,	'admin',	'3b42a9ea2b416048fdc2314418afead122a911ae',	'uBW5pOD9s',	'John',	'Doe',	'admin@gmail.com',	'',	'',	'',	1,	'2025-12-18 16:52:24');
...
CREATE TABLE `oc_zone` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`zone_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4236 DEFAULT CHARSET=utf8mb3;
